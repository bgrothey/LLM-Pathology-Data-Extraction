...
* r_scripts
   ...
   * analysis_4bit_fun.R
* data
   * PRAD_ground_truth.xlsx
   * PRAD_reports_eng.xlsx
   * PRAD_reports_ger.xlsx
...
* Key Features:
    * Input: .xlsx file with IDs and corresponding pathology reports. (See PRAD_reports_eng.xlsx / PRAD_reports_ger.xlsx)
...
* Key Features:
    * Input: JSON files generated by inference_4bit_models.py. In addition .xlsx file with IDs and corresponding pathology reports. (See PRAD_reports_eng.xlsx / PRAD_reports_ger.xlsx)
...
* Key Features:
    * Input: JSON files generated by the LLMs and a .xlsx file with ground truth data. For the format of the ground truth data table see PRAD_ground_truth.xlsx.
...
Running `inference_GPT4.py`
* <report_filename>: Path to the input .xlsx file containing pathology reports. (See PRAD_reports_eng.xlsx / PRAD_reports_ger.xlsx)
...
* <path_to_annotations>: Path to the ground truth annotations .xlsx file. (See PRAD_ground_truth.xlsx)
