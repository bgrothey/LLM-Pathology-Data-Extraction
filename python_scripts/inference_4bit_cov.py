...
def main():
    ...
    input_dir = './llama3_8b_4bit_zeroshot_eng_json/'

    # Output path for results
    output_dir = './llama3_8b_4bit_cov_eng_json/'
    stderr_out = './llama3_8b_4bit_cov_eng_report_stderr.txt'

    # Perform data aggregation
    data_aggregation(report_df, input_dir, query, output_dir, stderr_out, model='llama3:8b') # Select model
