...
def main():
    ...
    output_dir = './model_4bit_zeroshot_json/'
    stderr_out = './model_4bit_zeroshot_report_stderr.txt'

    # Perform data aggregation
    data_aggregation(report_df, query, output_dir, stderr_out, model='model') # Select model for inference
